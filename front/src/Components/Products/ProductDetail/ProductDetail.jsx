...
function ProductDetail(props) {
  const [numeroCantidad, setnumeroCantidad] = useState(1)
  const [aviso, setAviso] = useState("")

  function aumentarRestar(aumentar, stock) {
    if (aumentar) {
  ...
  return (
    <>
      ...
      <div className="container">
        <Link to="/products">
          <img
            style={{ height: "50px", marginBottom: "2rem" }}
            src={arrowBack}
            alt="img-arrow-back"
          />
        </Link>
          ...
          <div className={style.pDetail__containersTextsAndDescription}>
            <div className={style.pDetail__textsDetails__container}>
              <p className={style.pDetail__textsDetails__pb}>
                Rating: {props.producto.rating} stars ⭐
              </p>
              <p className={style.pDetail__spanReviews}>
                ({props.producto.numReviews}) reviews
              </p>
              <p className={style.pDetail__textsDetails__p}>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Dolorem quo nobis velit, illum consequuntur natus ipsa eius!
                Sequi commodi hic.
              </p>
              <p className={style.pDetail__textsDetails__pb}>
              ...
              <div className={style.pDetail__description__containerCantidad}>
                ...
                <p
                  onClick={() =>
                    aumentarRestar(true, props.producto.countInStock)
                  }
                  className={style.pDetailCantidad__p}
                >
                  ⬆
                </p>
                <p
                  onClick={() =>
                    aumentarRestar(false, props.producto.countInStock)
                  }
                  className={style.pDetailCantidad__p}
                >
                  ⬇
            ...
            <div className={style.pDetail__description__container}>
              ...
              <p className={style.pDetail__description__p}>
                {props.producto.description}
              </p>
              <p className={style.pDetail__description__pb2}>
